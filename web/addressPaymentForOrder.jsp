...
<thead>
    ...
    %>
          ...
          <th scope="col" style="background-color: yellow;">Total: <%out.print(total);%> $ </th>
          </tr>
        </thead>
        <thead>
          <tr>
        ...
        <tbody>
            ...
            <%
        ResultSet rs1 =st.executeQuery("select *from product inner join cart on product.id=cart.product_id and cart.email='"+email+"' ");
        while(rs1.next()){
         %>
          <tr>
          <%sno=sno+1;%>
